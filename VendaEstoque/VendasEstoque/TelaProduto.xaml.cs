...
namespace VendasEstoque
{
    ...
    {
        List<Produtos> ProdLista { get; set; }
        public TelaProduto()
        {
            InitializeComponent();
        ...
        public void TapGestureRecognizer_Tapped(object sender, EventArgs args)
        {
            ...
            Produtos produtos = tapGest.CommandParameter as Produtos;
            Navigation.PushAsync(new DetalharProduto(produtos));
        }
